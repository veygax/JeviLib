...
/// <summary>
/// Replacement for <see cref="WaitForSecondsRealtime"/>, because that shit doesn't work for some stupid ass reason.
/// </summary>
public class WaitSecondsReal : IEnumerator
{
    internal static ConstructorInfo ctor = typeof(WaitSecondsReal).GetConstructor(new Type[] { typeof(float) });
